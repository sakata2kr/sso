...
<%
    // =================================================================
    // Verify-Missing.asp - Sample page for FPS.
    //
    ...
    // Expected Input:
    //
    //   A list of field names that were a problem may be supplied as
    //    the Query String. The two types of problems which can occur 
    //    are 1) Missing value for required field and 2) Field contains 
    //    an asterisk ("*").
    //
    ...
    //
    //   Initial data arrives in a cookie called NPSFPSData.
    // =================================================================
%>
...
<%
    ...
    if(Question.length() < 1)
        response.sendRedirect(response.encodeRedirectURL("NoQuestions.htm"));
...
<HTML>
    <HEAD>
        ...
        <TITLE>Forgotten Password Services (Verify Missing)</TITLE>
