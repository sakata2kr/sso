<%
    // =================================================================
    // Verify-Timeout.asp - Sample page for FPS.
    //
    ...
    // clients.
    //
    // This page is invoked if the user fails to answer the verification
    // question within the timeout period.
    // =================================================================
%>
...
<HTML>
    <HEAD>
        ...
        <TITLE>Forgotten Password Services (Verify Timeout)</TITLE>
            ...
            <tr>
                <td align="center" valign="middle">
                    <font face="arial,helvetica" size="+1">
                        You did not answer quickly enough or have hit the Back button.
                        <br>
