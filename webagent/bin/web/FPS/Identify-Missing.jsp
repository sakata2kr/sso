...
<%
    // =================================================================
    // Identify-Missing.asp - Sample identification page for FPS.
    //
    ...
    // fields are removed, you *must* change APS.cfg in your
    ...
    //
    // Expected Input:
    //    Fields that are a problem will be provided in the query string.
    //    The two types of problems which can occur are 1) Missing value 
    //    for required field and 2) Field contains an asterisk ("*").
    //
...
<%
    ...
    boolean ShowRed;                            // Problem with current field?
...
<HTML>
    <HEAD>
        ...
        <TITLE>Forgotten Password Services (Identify-Missing)</TITLE>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&UserID&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&FirstName&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                        <b>*First Name:&nbsp;</b>
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&LastName&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                            <b>*Last Name:&nbsp;</b>
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&Phone&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                        <b>Phone:&nbsp;</b>
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&Mail&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                        <b>Email Address:&nbsp;</b>
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&City&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                        <b>City:&nbsp;</b>
                                ...
                                <tr>
                                    <td align="right">
                                        <% ShowRed = (Problem.indexOf("&State&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
                                        <b>State:&nbsp;</b>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <% ShowRed = (Problem.indexOf("&phonenow&") > -1);
                                           if( ShowRed ){ %>
                                            <font color="red">
                                        <% } %>                               
