<%
    // =================================================================
    // Verify-NoData.asp - Sample page for FPS.
    //
    ...
    // clients.
    //
    // This page is invoked when data is required for verification,
...
<HTML>
    <HEAD>
        ...
        <TITLE>Forgotten Password Services (Verify No Data)</TITLE>
            ...
            <tr>
                <td align="center" valign="middle">
                    <font face="arial,helvetica" size="+1">
                        Sorry, your profile does not contain the information required to perform this service.
                        <br>
