<%
    // =================================================================
    // Identify-Lockout.asp - Sample page for FPS.
    //
    ...
    // clients.
    //
    // This page is invoked when the only user that satisfies the search
    // criteria is locked out of FPS.
    // =================================================================
%>
<HTML>
    <HEAD>
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        <TITLE>Forgotten Password Services (Lockout)</TITLE>
            ...
            <tr>
                <td align="center" valign="middle">
                    <font face="arial,helvetica" size="+1">
                        Your user id is currently prevented from running this service.
                        <br>
